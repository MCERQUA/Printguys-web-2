# TASK T021: Add LocalBusiness Schema Markup
...
1. Create schema component at /src/components/seo/schema-markup.tsx:
```typescript
...
2. Add LocalBusinessSchema to root layout

3. Add FAQSchema to /faq page

4. Add BreadcrumbSchema to service pages

## OUTPUT
- Write results to: /home/nick/Nick/Printguys-AI/printguys-nextjs/z-code-outputs/agent8-T021.md
