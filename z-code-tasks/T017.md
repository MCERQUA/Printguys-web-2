# TASK T017: Build Customers List Page

## OBJECTIVE
Create admin customers management page.
...
1. Create customers page at /src/app/admin/customers/page.tsx:
```typescript
...
2. Create customer detail page at /src/app/admin/customers/[id]/page.tsx with:
- Customer info
- Order history
- Saved designs
- Activity log
...
## OUTPUT
- Write results to: /home/nick/Nick/Printguys-AI/printguys-nextjs/z-code-outputs/agent7-T017.md
